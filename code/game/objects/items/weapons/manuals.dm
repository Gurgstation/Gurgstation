...
/obj/item/weapon/book/manual/rust_engine/New()
	...
	dat = {"<html>
				...
				<li>Go into the control room, interact with the fusion core control console. Turn the field on and raise size to 499. Any bigger and it will start EMPing the doors. Any smaller and the fuel pellets might miss.</li>
