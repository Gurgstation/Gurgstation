...
/decl/emote/audible/belch/do_sound(var/atom/user)
	...
	if(sound_to_play)
		playsound(user.loc, sound_to_play, (30+rand(0,50)), vary = 1, falloff = 0.1, ignore_walls = TRUE, preference = /datum/client_preference/emote_noises) //VOREStation Add - Preference // JOKES ON YOU BISH I ADDED A DIFFERENT PREFERENCE OVER YOURS BISH DESTROY'D
