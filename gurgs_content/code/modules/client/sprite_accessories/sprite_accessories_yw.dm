/datum/sprite_accessory/ears/yw
	icon = 'gurgs_content/icons/mob/human_races/markings_yw.dmi'
...
/datum/sprite_accessory/wing/bat_purpley_yw
	...
	desc = ""
	icon = 'gurgs_content/icons/mob/vore/wings_yw.dmi'
...
/datum/sprite_accessory/tail/tripplekitsune_colorable_yw
	icon = 'gurgs_content/icons/mob/vore/tails_yw.dmi'
...
/datum/sprite_accessory/tail/jeanne_nanovulp
	icon = 'gurgs_content/icons/mob/human_races/cyberlimbs/dopiotl/jeanne_nanovulp.dmi'
...
/datum/sprite_accessory/ears/large_dragon
	icon = 'gurgs_content/icons/mob/vore/ears_yw.dmi'
