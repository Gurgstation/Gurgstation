/datum/sprite_accessory/marking/ch
	icon = 'gurgs_content/icons/mob/human_races/markings_ch.dmi'
	orca_head
		name = "Orca head"
...
/datum/sprite_accessory/hair/ch
	icon = 'gurgs_content/icons/mob/human_face_ch.dmi'
	icon_add = 'gurgs_content/icons/mob/human_face_ch_add.dmi'
	cotton
		name = "Cotton"
