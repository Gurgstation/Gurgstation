...
mv "triumph-02-deck2_nanomap_z2.png" "triumph_nanomap_z2.png"
mv "triumph-03-deck3_nanomap_z3.png" "triumph_nanomap_z3.png"
mv "triumph-04-deck4_nanomap_z4.png" "triumph_nanomap_z4.png"
