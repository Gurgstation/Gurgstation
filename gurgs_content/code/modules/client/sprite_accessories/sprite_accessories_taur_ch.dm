/datum/sprite_accessory/tail/taur/ch
	icon = 'gurgs_content/icons/mob/vore/taurs_ch.dmi'//Parent which allows us to not need to set icon every time.
...
/datum/sprite_accessory/tail/taur/ch/naga/alt
	...
	suit_sprites = 'gurgs_content/icons/mob/taursuits_naga_ch.dmi'
