...
/obj/item/weapon/melee/dallus/
	icon = 'gurgs_content/icons/obj/killbow_weapon.dmi'
	item_icons = list(
			slot_l_hand_str = 'gurgs_content/icons/obj/killbow_weapon_inhand_left.dmi',
			slot_r_hand_str = 'gurgs_content/icons/obj/killbow_weapon_inhand_right.dmi',
			)
