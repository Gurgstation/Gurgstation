...
/mob/living/simple_mob/vore/bigdragon
	...
	icon = 'gurgs_content/icons/mob/vore128x64_ch.dmi'
	...
	var/gut2
	var/small = 0
	var/small_icon = 'gurgs_content/icons/mob/bigdragon_small_ch.dmi'
...
/mob/living/simple_mob/vore/bigdragon/proc/set_style()
	...
	for(var/option in options)
		LAZYSET(options, option, new /image('gurgs_content/icons/effects/bigdragon_labels_ch.dmi', option))
