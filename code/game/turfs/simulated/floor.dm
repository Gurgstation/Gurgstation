...
/turf/simulated/floor/Initialize(mapload, floortype)
	...
	if(floortype)
		...
		vorefootstep_sounds = base_vorefootstep_sounds // Gurg ADD: Import Chomp liquid bellies
...
/turf/simulated/floor/proc/set_flooring(var/decl/flooring/newflooring, var/initializing)
	...
	vorefootstep_sounds = newflooring.vorefootstep_sounds // Gurg ADD: Import Chomp liquid bellies
